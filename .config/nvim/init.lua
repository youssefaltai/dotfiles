...
--  Use CTRL+<hjkl> to switch between windows and tmux panes (via vim-tmux-navigator)
--
--  See `:help wincmd` for a list of all window commands
-- NOTE: vim-tmux-navigator plugin handles these keybindings instead
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local filetypes = { 'bash', 'c', 'dart', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
